...
deny-by-default: raw snapshots, generated catalogs, and QA reports are ignored unless a future
explicit ticket approves an exact-path exception.
...
- `source-snapshots/` stores raw source captures and snapshot manifests after EPIC-02 introduces
  fetchers. Contents stay ignored by default.
...
Screenshots and prior-art images are development references only and must not be committed as runtime
assets by this sprint.
