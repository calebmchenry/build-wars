...
inspect generated manifests before deleting old local snapshots. EPIC-04 and EPIC-10 production
refreshes additionally require a reviewed source plan, digest-confirmed fetch, and one complete
selected snapshot-set manifest before offline replay can promote generated bytes. Ignored snapshots
may be deleted when no exact-path promotion ticket or active review needs them.
