...
### EPIC-19 rune icon provenance

BW-1904/ADR 0002 additionally allowlists exactly
`data/generated/epic-10/rune-icon-assets.manifest.json`, via
`!data/generated/epic-10/rune-icon-assets.manifest.json` in `.gitignore`.
It records source identity and verified hashes for 30 immutable local PNGs and
126 rune mappings. Runtime consumes `src/app/rune-icon-assets.generated.json`;
no promoted catalog or catalog manifest is regenerated by the cache.
